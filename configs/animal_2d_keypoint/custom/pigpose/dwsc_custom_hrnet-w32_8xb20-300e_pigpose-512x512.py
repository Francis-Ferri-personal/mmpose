...
# runtime
train_cfg = dict(max_epochs=180, val_interval=10)
...
model = dict(
    ...
    head=dict(
        ...
        decoder=codec,
        conv_type='DepthwiseSeparableConvModule', # 1x1Conv, Conv2d, DepthwiseSeparableConvModule, DilatedConv, DeformConv2d, AdaptiveRotatedConv2d
    ),
